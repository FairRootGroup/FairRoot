...
FairEveTracks::FairEveTracks():fEventManager(nullptr),fEveTrList(nullptr),
fPt{0,10},fEta{-10,10},fEnergy{0,10},fUsePt(kFALSE),fUseEta(kFALSE),fUseEnergy(kFALSE),
fTrPropagator(nullptr),fTrackGroup(nullptr)
{
