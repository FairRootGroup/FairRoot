 ...
 */
class FairEveTracks: public TEveElement, public TNamed{
...
public:
     ...
     * @param use
     */
    void SetPtCut(Double_t min, Double_t max, Bool_t use){fPt[0]=min; fPt[1]=max;fUsePt=use;};
    /**
     ...
     * @param use
     */
    void SetEtaCut(Double_t min, Double_t max,Bool_t use){fEta[0] = min; fEta[1] = max;fUseEta= use;}
    /**
     ...
     * @param use
     */
    void SetEnergyCut(Double_t min, Double_t max, Bool_t use){fEnergy[0] = min; fEnergy[1] = max; fUseEnergy =use;}
    /**
