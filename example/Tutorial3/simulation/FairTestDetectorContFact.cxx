...
void FairTestDetectorContFact::setAllContainers()
{
  ...
  */
  ...
  FairContainer* p= new FairContainer("FairTestDetectorGeoPar",
                                      "FairTestDetector Geometry Parameters",
                                      "TestDefaultContext");
...
FairParSet* FairTestDetectorContFact::createContainer(FairContainer* c)
{
  ...
  */
  ...
  if (strcmp(name,"FairTestDetectorGeoPar")==0) {
    p=new FairTestDetectorGeoPar(c->getConcatName().Data(),
                                 c->GetTitle(),c->getContext());
  }
  if(strcmp(name,"FairConstPar")==0) {
    p=new FairConstPar(c->getConcatName().Data(),
                       c->GetTitle(),c->getContext());
  }
