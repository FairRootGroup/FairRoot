...
void FairTestDetector::Register()
{
  ...
  */
  ...
  FairRootManager::Instance()->Register("FairTestDetectorPoint", "FairTestDetector",
                                        fFairTestDetectorPointCollection, kTRUE);
...
{
  if (iColl == 0) { return fFairTestDetectorPointCollection; }
  else { return NULL; }
}
...
FairTestDetectorPoint* FairTestDetector::AddHit(Int_t trackID, Int_t detID,
    ...
    Double_t eLoss)
{
  ...
  return new(clref[size]) FairTestDetectorPoint(trackID, detID, pos, mom,
