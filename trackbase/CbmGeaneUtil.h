...
class CbmGeaneUtil : public TObject
{
 ...
 public:
  ...
  void FromPtToSD(Double_t PD[3], Double_t RD[15], Double_t H[3], Double_t CH,
  ...
  void FromSCToSD(Double_t PC[3], Double_t RC[15], Double_t H[3], Double_t CH,
  ...
  void FromSDToSC(Double_t PD[3], Double_t RD[15], Double_t H[3], Double_t CH,
		  Double_t SPU, Double_t DJ[3], Double_t DK[3],
		  Int_t &IERR, Double_t* PC, Double_t* RC);

  typedef Double_t sixMat[6][6];
  void FromSCToMars(Double_t PC[3], Double_t RC[15], Double_t H[3], Double_t CH,
