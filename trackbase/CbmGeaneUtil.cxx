...
CbmGeaneUtil::CbmGeaneUtil() { }

CbmGeaneUtil::~CbmGeaneUtil() { }

void CbmGeaneUtil::FromPtToSC(Double_t PC[3], Double_t RC[15], 
			      //     output
...
void CbmGeaneUtil::FromPtToSD(Double_t PD[3], Double_t RD[15], Double_t H[3], Double_t CH,
...
void CbmGeaneUtil::FromSCToPt(Double_t PC[3], Double_t RC[15],
		 //  output
                 Double_t* PD, Double_t* RD, Int_t &IERR) {
...
void CbmGeaneUtil::FromSCToSD(Double_t PC[3], Double_t RC[15], Double_t H[3], Double_t CH,
...
void CbmGeaneUtil::FromSD1ToSD2(Double_t PD1[2], Double_t RD1[15],Double_t H[2],
...
void CbmGeaneUtil::FromSDToPt(Double_t PD[3], Double_t RD[15], Double_t H[3], 
...
void CbmGeaneUtil::FromSDToSC(Double_t PD[3], Double_t RD[15], Double_t H[3], Double_t CH,
...
void CbmGeaneUtil::FromVec15ToMat25(Double_t V[15], fiveMat& A) {
  //
  //   ------------------------------------------------------            
...
void CbmGeaneUtil::FromVecToMat(fiveMat& A, Double_t V[25]) {
  //
  //   ------------------------------------------------------            
...
void CbmGeaneUtil::FromMarsToSC(Double_t PD[3], Double_t RD[6][6],  Double_t H[3], Double_t CH, 
				//  output 
...
void CbmGeaneUtil::FromSCToMars(Double_t PC[3], Double_t RC[15], Double_t H[3], Double_t CH,
				//  output
...
void CbmGeaneUtil::FromMarsToSD(Double_t PD[3], Double_t RD[6][6], 
...
void CbmGeaneUtil::FromSDToMars(Double_t PC[3], Double_t RC[15],
 				Double_t H[3], Double_t CH,
...
void CbmGeaneUtil::FromMat25ToVec15(Double_t A[5][5], Double_t* V) {
  //
  //   ------------------------------------------------------            
...
void CbmGeaneUtil::FromMatToVec(Double_t A[5][5], Double_t* V) {
  //
  //   ------------------------------------------------------            
...
void CbmGeaneUtil::SymmProd(Double_t A[25], Double_t S[15], Double_t* R) {
  //
  //  ---------------------------------------------------------            
...
TVector3  CbmGeaneUtil::FromMARSToSDCoord(TVector3 xyz, TVector3 o, TVector3 di, TVector3 dj, TVector3 dk)
{
...
TVector3  CbmGeaneUtil::FromSDToMARSCoord(TVector3 uvw, TVector3 o, TVector3 di, TVector3 dj, TVector3 dk)
{
  TMatrixT<double> matrix(3,3);
  matrix[0][0] = di[0];
  matrix[0][1] = di[1];
