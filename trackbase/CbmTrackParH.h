...
class CbmTrackParH : public CbmTrackPar
{
 ...
 public:
  ...
  CbmTrackParH(TVector3 pos, TVector3 Mom, TVector3 posErr, TVector3 MomErr, Double_t q);

  /** copy Constructor **/
  CbmTrackParH(CbmTrackPar &Trkbase);

  //CbmTrackParH(CbmTrackParH &Trk);

  /** Destructor **/
  virtual ~CbmTrackParH();       
