...
#ifndef CBMSTSTRACKPARP
#define CBMSTSTRACKPARP 1
#include "TVector3.h"
#include "CbmTrackPar.h"
    
class CbmTrackParP : public CbmTrackPar
{
 ...
 public:
  ...
  CbmTrackParP(Double_t v, Double_t w, 
  ...
  CbmTrackParP(TVector3 pos, TVector3 Mom, 
