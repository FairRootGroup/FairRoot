...
ClassImp(CbmGeoAsciiIo)

CbmGeoAsciiIo::CbmGeoAsciiIo() 
  :filename(""),
   filedir(""),
   writable(kFALSE),
   file(0)
...
Bool_t CbmGeoAsciiIo::open(const char* fname,const Text_t* status) {
...
Bool_t CbmGeoAsciiIo::read(CbmGeoMedia* media) {
...
Bool_t CbmGeoAsciiIo::read(CbmGeoSet* set,CbmGeoMedia* media) {
...
Bool_t CbmGeoAsciiIo::write(CbmGeoMedia* media) {
...
Bool_t CbmGeoAsciiIo::write(CbmGeoSet* set) {
...
Bool_t CbmGeoAsciiIo::readGeomConfig(CbmGeoInterface* interface) {
  ...
  Bool_t rc=kTRUE;
  CbmGeoIo* oraIo=interface->getOraInput(); 
  if (oraIo) {
...
Bool_t CbmGeoAsciiIo::readDetectorSetup(CbmGeoInterface* interface) {
