...
Int_t CbmGeoTubs::readPoints(fstream* pFile,CbmGeoVolume* volu) {
...
Bool_t CbmGeoTubs::writePoints(fstream* pFile,CbmGeoVolume* volu) {
...
void CbmGeoTubs::printPoints(CbmGeoVolume* volu) {
...
TArrayD* CbmGeoTubs::calcVoluParam(CbmGeoVolume* volu) {
...
void CbmGeoTubs::calcVoluPosition(CbmGeoVolume* volu,
