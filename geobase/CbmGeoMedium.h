 ...
 * @author ilse koenig 
 */
class CbmGeoMedium  : public TNamed {
private:
...
//private:  
  CbmGeoMedium(const CbmGeoMedium &L);
  CbmGeoMedium& operator= (const CbmGeoMedium&) {return *this;}
  ClassDef(CbmGeoMedium,1) //
};

inline Bool_t CbmGeoMedium::isSensitive() {
