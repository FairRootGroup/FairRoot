...
ClassImp(CbmGeoMedium)

CbmGeoMedium::CbmGeoMedium(const char* name) : TNamed(), 
  medId(0),
  autoflag(1),
  nComponents(0),
  weightFac(0),
...
void CbmGeoMedium::setNComponents(Int_t n) {
...
Bool_t CbmGeoMedium::setComponent (Int_t i,Double_t a,Double_t z,Double_t weight) {
...
void CbmGeoMedium::getComponent(Int_t i,Double_t* p) {
...
void CbmGeoMedium::setNpckov (Int_t n) {
...
Bool_t CbmGeoMedium::setCerenkovPar(Int_t i,Double_t p,Double_t a,Double_t e ,Double_t r) {  
...
void CbmGeoMedium::getCerenkovPar(Int_t i,Double_t* p) {
...
void CbmGeoMedium::setMediumPar(Int_t sensitivityFlag,Int_t fieldFlag,
...
void CbmGeoMedium::getMediumPar(Double_t* params) {
...
void CbmGeoMedium::read(fstream& fin, Int_t aflag ) {
...
void CbmGeoMedium::write (fstream& fout) {
...
Bool_t CbmGeoMedium::calcRadiationLength() {
