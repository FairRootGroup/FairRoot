...
ClassImp(CbmGeoRootBuilder)

CbmGeoRootBuilder::CbmGeoRootBuilder()
  : geoManager(0)
{
  // Default constructor
}

CbmGeoRootBuilder::CbmGeoRootBuilder(const char* name,const char* title)
...
Bool_t CbmGeoRootBuilder::createNode(CbmGeoNode* volu, Int_t hadFormat) {
  // Creates the volume
...
Int_t CbmGeoRootBuilder::createMedium(CbmGeoMedium* med) {
  // Creates the medium
...
void CbmGeoRootBuilder::finalize() {
...
void CbmGeoRootBuilder::checkOverlaps(Double_t ovlp) {
