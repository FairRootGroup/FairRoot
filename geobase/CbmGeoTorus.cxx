...
ClassImp(CbmGeoTorus)

CbmGeoTorus::CbmGeoTorus() {
  // constructor
  fName="TORUS";
  nPoints=5;
  nParam=5;
...
Int_t CbmGeoTorus::readPoints(fstream* pFile,CbmGeoVolume* volu) {
...
TArrayD* CbmGeoTorus::calcVoluParam(CbmGeoVolume* volu) {
  ...
  CbmGeoVector v=*(volu->getPoint(3));
  param->AddAt(v(0),3);
...
Bool_t CbmGeoTorus::writePoints(fstream* pFile,CbmGeoVolume* volu) {
...
void CbmGeoTorus::printPoints(CbmGeoVolume* volu) {
...
void CbmGeoTorus::calcVoluPosition(CbmGeoVolume* volu,
