...
MyConstField::MyConstField(const char* name, Double_t xMin, 
...
{
  if ( ! fieldPar ) {
    cerr << "-W- MyConstField::MyConstField: empty parameter container!"
	 << endl;
    fType=0;
  }
  else {
...
// -----   Set field region   ----------------------------------------------
void MyConstField::SetFieldRegion(Double_t xMin, Double_t xMax, 
