...
# The rename script exchange all occurence of MyProj
# by the name given by the first parameter.
...
if [ $# -ne 3 ]; then
  ...
  echo "name of the Project. The second is the name of the project. This"
