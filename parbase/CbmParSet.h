...
public:
  CbmParSet(const char* name="",const char* title="",const char* context="");
  virtual ~CbmParSet() {}
  virtual Bool_t init();
  virtual Bool_t init(CbmParIo* io) { return kFALSE; }
  virtual Int_t write();
  virtual Int_t write(CbmParIo*) { return kFALSE; }
  virtual void clear() {}
  virtual void print();
  ...
  void copyComment(CbmParSet& r) {
    author=r.getAuthor();
    description=r.getDescription();
  }

  ClassDef(CbmParSet,1) // Base class for all parameter containers
};
