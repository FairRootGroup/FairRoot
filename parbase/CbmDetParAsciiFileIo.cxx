...
ClassImp(CbmDetParAsciiFileIo)

CbmDetParAsciiFileIo::CbmDetParAsciiFileIo(fstream* f) {
  // constructor
  pFile=f;
  sepLine=
    "##############################################################################\n";
...
Bool_t CbmDetParAsciiFileIo::findContainer(const Text_t* name) {
...
void CbmDetParAsciiFileIo::writeHeader(const Text_t* name, const Text_t* context,
...
void CbmDetParAsciiFileIo::readComment(const char* lastBuf, CbmParSet* pPar) {
...
void CbmDetParAsciiFileIo::writeComment(CbmParSet* pPar) {
