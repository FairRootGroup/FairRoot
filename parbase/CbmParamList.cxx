...
//  list elements in CbmParamList::paramList.
...
ClassImp(CbmParamObj)
 
CbmParamObj::CbmParamObj(const Text_t* name,const Text_t* value,
...
CbmParamObj::CbmParamObj() 
: nParam(0)
{
}
void CbmParamObj::print() {
...
//  elements in CbmParamList::paramBinList.
...
ClassImp(CbmParamBinObj)
 
CbmParamBinObj::CbmParamBinObj() {
...
CbmParamBinObj::CbmParamBinObj(CbmParamBinObj& o) {
  // Copy constructor
  SetName(o.GetName());
...
CbmParamBinObj::CbmParamBinObj(const Text_t* name,const UChar_t* value,const Int_t length) {
...
CbmParamBinObj::CbmParamBinObj(const Text_t* name,const Short_t* value,const Int_t nValues) {
...
CbmParamBinObj::CbmParamBinObj(const Text_t* name,const Int_t* value,const Int_t nValues) {
...
CbmParamBinObj::CbmParamBinObj(const Text_t* name,const Float_t* value,const Int_t nValues) {
...
CbmParamBinObj::CbmParamBinObj(const Text_t* name,const Double_t* value,const Int_t nValues) {
...
void CbmParamBinObj::setParamType(const Text_t* t) {
...
void CbmParamBinObj::setParamValue(UChar_t* value,const Int_t length) {
...
void CbmParamBinObj::setLength(Int_t l) {
...
void CbmParamBinObj::fill(const Text_t* name,UChar_t* value,const Int_t length) {
...
void CbmParamBinObj::fill(const Text_t* name,Short_t* value,const Int_t nValues)   // Sets the name and value (Short_t array) of an existing object 
{
  SetName(name);
  paramType="hBin";
  basicType=kTRUE;
...
void CbmParamBinObj::fill(const Text_t* name,Int_t* value,const Int_t nValues) {
...
void CbmParamBinObj::fill(const Text_t* name,Float_t* value,const Int_t nValues)   // Sets the name and value (Float_t array) of an existing object 
{
  SetName(name);
  paramType="fBin";
  basicType=kTRUE;
...
void CbmParamBinObj::fill(const Text_t* name,Double_t* value,const Int_t nValues)  // Sets the name and value (Double_t array) of an existing object 
 {
  SetName(name);
  paramType="dBin";
  basicType=kTRUE;
...
Int_t CbmParamBinObj::getNumParams() {
  ...
  if (basicType) {
    switch(paramType[0]) {
      ...
      default: Error("CbmParamBinObj::getNumParams()","Unknown Type %s",paramType.Data());
    }
  } else n=1;  // always 1 for classes
  return n;
}

void CbmParamBinObj::print() {
  ...
  if (!basicType) {
    ...
    switch(paramType[0]) {
      ...
      case 'd':
        ...
        break;
      default:
        Error("CbmParamBinObj::getNumParams()","Unknown Type %s",paramType.Data());
    }
  }
}
...
ClassImp(CbmParamList)

CbmParamList::CbmParamList() {
  // Constructor
  paramList=new TList;
...
void CbmParamList::add(CbmParamObj& p) {
  // Adds a CbmParamObj object to the list
  paramList->Add(new CbmParamObj(p.GetName(),p.getParamValue(),
                               p.getParamType(),p.getNumParams()));
}

void CbmParamList::addBinary(CbmParamBinObj& p) {
  // Adds a HBinParamObj object to the list
  paramBinList->Add(new CbmParamBinObj(p));
}

void CbmParamList::add(const Text_t* name,const Text_t* value,
                     const char type,const Int_t n) {
  paramList->Add(new CbmParamObj(name,value,type,n));
}

void CbmParamList::add(const Text_t* name,const Int_t value) {
  const char f[]="%i";
  Text_t buf[100];
  sprintf(buf,f,value);
  paramList->Add(new CbmParamObj(name,buf,'i',1));
}

void CbmParamList::add(const Text_t* name,const UInt_t value) {
  const char f[]="%u";
  Text_t buf[100];
  sprintf(buf,f,value);
  paramList->Add(new CbmParamObj(name,buf,'u',1));
}

void CbmParamList::add(const Text_t* name,const Long_t value) {
  const char f[]="%ld";
  Text_t buf[100];
  sprintf(buf,f,value);
  paramList->Add(new CbmParamObj(name,buf,'l',1));
}

void CbmParamList::add(const Text_t* name,const Float_t value,const Int_t precision) {
  Text_t f[100];
  sprintf(f,"%s%i%s","%.",precision,"f");
  Text_t buf[100];
  sprintf(buf,f,value);
  paramList->Add(new CbmParamObj(name,buf,'f',1));
}

void CbmParamList::add(const Text_t* name,const Double_t value,const Int_t precision) {
  Text_t f[100];
  sprintf(f,"%s%i%s","%.",precision,"lf");
  Text_t buf[100];
  sprintf(buf,f,value);
  paramList->Add(new CbmParamObj(name,buf,'d',1));
}

void CbmParamList::add(const Text_t* name,TArrayI& value) {
  ...
  paramList->Add(new CbmParamObj(name,s,'i',n));
}

void CbmParamList::add(const Text_t* name,TArrayC& value) {
  Int_t n=value.GetSize();
  const char f[]="%i";
  Text_t buf[100];
  TString s;
...
void CbmParamList::add(const Text_t* name,TArrayF& value,const Int_t precision){
  Int_t n=value.GetSize();
  Text_t f[100];
  sprintf(f,"%s%i%s","%.",precision,"f");
  Text_t buf[100];
  ...
  paramList->Add(new CbmParamObj(name,s,'f',n));
}

void CbmParamList::add(const Text_t* name,TArrayD& value,const Int_t precision){
  Int_t n=value.GetSize();
  Text_t f[100];
  sprintf(f,"%s%i%s","%.",precision,"lf");
  Text_t buf[100];
  ...
  paramList->Add(new CbmParamObj(name,s,'d',n));
}

void CbmParamList::addBinary(const Text_t* name,const UChar_t* values,const Int_t nValues){
  paramBinList->Add(new CbmParamBinObj(name,values,nValues));
}

void CbmParamList::addBinary(const Text_t* name,const Short_t* values,const Int_t nValues){
  paramBinList->Add(new CbmParamBinObj(name,values,nValues));
}

void CbmParamList::addBinary(const Text_t* name,const Int_t* values,const Int_t nValues){
  paramBinList->Add(new CbmParamBinObj(name,values,nValues));
}

void CbmParamList::addBinary(const Text_t* name,const Float_t* values,const Int_t nValues){
  paramBinList->Add(new CbmParamBinObj(name,values,nValues));
}

void CbmParamList::addBinary(const Text_t* name,const Double_t* values,const Int_t nValues){
  paramBinList->Add(new CbmParamBinObj(name,values,nValues));
}

void CbmParamList::addBinary(const Text_t* name,TObject* obj) {
  if (!obj) return;
...
void CbmParamList::print() {
  TIter next(paramList);
  CbmParamObj* o;
  while ((o=(CbmParamObj*)next())!=0) o->print();
  TIter nextBin(paramBinList);
  CbmParamBinObj* b;
  while ((b=(CbmParamBinObj*)nextBin())!=0) b->print();
}

Bool_t CbmParamList::fill(const Text_t* name,Text_t* value,const Int_t length) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  ...
  if (o!=0 && o->getParamType()=='s') {
    ...
    if (l<length) {
      ...
      return kTRUE;
    } else Error("CbmParamList::fill(const Text_t*,Text_t*)",
                 "char array too small");
  }
  Error("CbmParamList::fill \nNot found: %s",name);
  return kFALSE;
}

Bool_t CbmParamList::fill(const Text_t* name,Int_t* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fill(const Text_t* name,UInt_t* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fill(const Text_t* name,Long_t* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fill(const Text_t* name,Float_t* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fill(const Text_t* name,Double_t* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fill(const Text_t* name,TArrayI* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fill(const Text_t* name,TArrayC* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
  if (o!=0 && o->getParamType()=='i') {
    Int_t n=o->getNumParams();
...
Bool_t CbmParamList::fill(const Text_t* name,TArrayF* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fill(const Text_t* name,TArrayD* value) {
  CbmParamObj* o=(CbmParamObj*)paramList->FindObject(name);
  if (value==0) return kFALSE;
...
Bool_t CbmParamList::fillBinary(const Text_t* name,UChar_t* values,const Int_t nValues) {
  // Fills the array (no resize).
  if (values==0) return kFALSE;
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
...
Bool_t CbmParamList::fillBinary(const Text_t* name,Short_t* values,const Int_t nValues) {
  // Fills the array (no resize).
  if (values==0) return kFALSE;
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
...
Bool_t CbmParamList::fillBinary(const Text_t* name,Int_t* values,const Int_t nValues) {
  // Fills the array (no resize).
  if (values==0) return kFALSE;
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
...
Bool_t CbmParamList::fillBinary(const Text_t* name,Float_t* values,const Int_t nValues) {
  // Fills the array (no resize).
  if (values==0) return kFALSE;
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
...
Bool_t CbmParamList::fillBinary(const Text_t* name,Double_t* values,const Int_t nValues) {
  // Fills the array (no resize).
  if (values==0) return kFALSE;
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
...
Int_t CbmParamList::fillBinary(const Text_t* name,UChar_t* values) {
...
Int_t CbmParamList::fillBinary(const Text_t* name,Short_t* values) {
  // Recreates the array and returns the number of array elements
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
  if (o!=0 && strcmp(o->getParamType(),"hBin")==0) {
    Int_t l=o->getLength();
...
Int_t CbmParamList::fillBinary(const Text_t* name,Int_t* values) {
  // Recreates the array and returns the number of array elements
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
  if (o!=0 && strcmp(o->getParamType(),"iBin")==0) {
    Int_t l=o->getLength();
...
Int_t CbmParamList::fillBinary(const Text_t* name,Float_t* values) {
  // Recreates the array and returns the number of array elements
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
  if (o!=0 && strcmp(o->getParamType(),"fBin")==0) {
    Int_t l=o->getLength();
...
Int_t CbmParamList::fillBinary(const Text_t* name,Double_t* values) {
  // Recreates the array and returns the number of array elements
  CbmParamBinObj* o=(CbmParamBinObj*)paramBinList->FindObject(name);
  if (o!=0 && strcmp(o->getParamType(),"dBin")==0) {
    Int_t l=o->getLength();
...
Int_t CbmParamList::fillBinary(const Text_t* name,TObject* obj) {
  ...
  if (o!=0 && strcmp(o->getParamType(),obj->IsA()->GetName())==0) {
    if (o->getClassVersion()!=obj->IsA()->GetClassVersion())
      Warning("CbmParamList::fillBinary",
