// -------------------------------------------------------------------------
// -----                  CbmPrimaryGenerator header file              -----
 ...
 *
The CbmPrimaryGenerator is responsible for the handling of the MC input.
Several input generators can be registered to it; these have to be
derived from the CbmGenerator class. The CbmPrimaryGenerator defines
...
class CbmPrimaryGenerator : public TNamed 
{
 ...
 public:
  ...
  /** Register a generator derived from CbmGenerator.  **/
  void AddGenerator(CbmGenerator* generator) {
    if ( ! fGenList ) {
  ...
  /** Public method GenerateEvent
      To be called at the beginning of each event from CbmMCApplication.
  ...
  **/
  Bool_t GenerateEvent(CbmGenericStack* pStack);
  ...
  **/
  ...
  void SetEvent(CbmMCEventHeader* event) { fEvent = event; };


  /** Accessor to the MCEvent **/
  CbmMCEventHeader* GetEvent() { return fEvent; };
  ...
  **/
  ...
  CbmPrimaryGenerator(const CbmPrimaryGenerator &P);
  CbmPrimaryGenerator& operator= (const  CbmPrimaryGenerator&) {return *this;}
