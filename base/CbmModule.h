 ...
 */
class CbmModule:  public TNamed
{
public:
	/**default ctor*/
    CbmModule();
    /**Standard ctor*/
    CbmModule(const char * Name, const char *title, Bool_t Active=kFALSE);
    /**default dtor*/
    virtual  ~CbmModule();
    ...
    CbmVolume*		getCbmVolume(CbmGeoNode *fNode);
    void		AddSensitiveVolume(TGeoVolume *v);
   
private:
   CbmModule(const CbmModule &M);
   CbmModule& operator= (const CbmModule&) {return *this;}
