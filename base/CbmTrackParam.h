...
class CbmTrackParam : public TObject
{
 ...
 public:
  ...
  CbmTrackParam(Double_t x,  Double_t y,  Double_t z,
		Double_t tx, Double_t ty, Double_t qp,
		const TMatrixFSym& covMat);


  /** Copy constructor **/
  CbmTrackParam(const CbmTrackParam& param); 


  /** Destructor **/
  virtual ~CbmTrackParam();
  ...
  /** Assignment operator  **/
  CbmTrackParam& operator=(const CbmTrackParam& par );
