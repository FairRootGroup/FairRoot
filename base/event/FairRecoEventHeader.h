...
class FairRecoEventHeader : public TNamed
{
  ...
  public:
    ...
    */
     ...
     */
    void SetEventTime(Double_t time, Double_t terr) {fEventTime=time;fEventTimeError=terr;}
    ...
    */
    ...
    virtual bool operator<(const FairRecoEventHeader& tempObj) const{
      if (fEventTime < tempObj.GetEventTime()) return true; else if (fEventTime > tempObj.GetEventTime()) return false;
      return false;
    }
