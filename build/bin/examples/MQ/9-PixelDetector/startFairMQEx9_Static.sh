...
WORKDIR="/Users/turany/development/FairRoot"
...
SERVER="/Users/turany/development/FairRoot/build/bin/"
...
########################## start SAMPLER
SAMPLER="/Users/turany/development/FairRoot/build/bin/examples/MQ/9-PixelDetector/"
SAMPLER+="ex9-sampler $TRANSPORT"
SAMPLER+=" --id sampler1  --mq-config $MQCONFIGFILE"
SAMPLER+=" $VERBOSE --ack-channel ack "
SAMPLER+=" --file-name $INPUTFILE --branch-name $INPUTBRANCH $MAXINDEX --control static --log-color false"

########################## start PROCESSORs
PROCESSOR1="/Users/turany/development/FairRoot/build/bin/examples/MQ/9-PixelDetector/"
...
PROCESSOR2="/Users/turany/development/FairRoot/build/bin/examples/MQ/9-PixelDetector/"
...
PROCESSOR3="/Users/turany/development/FairRoot/build/bin/examples/MQ/9-PixelDetector/"
...
########################## start FILESINK
FILESINK="/Users/turany/development/FairRoot/build/bin/examples/MQ/9-PixelDetector/"
FILESINK+="ex9-sink $TRANSPORT"
FILESINK+=" $VERBOSE --ack-channel ack "
FILESINK+=" --id sink1 --mq-config $MQCONFIGFILE"
FILESINK+=" --file-name $OUTPUTFILE $OUTPUTCLASS $OUTPUTBRANCH --control static --log-color false"

$SERVER &> server.out.log &
SERVER_PID=$!

$SAMPLER &> sampler.out.log &
SAMPLER_PID=$!

$PROCESSOR1 &> processor1.out.log &
PROCESSOR1_PID=$!

$PROCESSOR2 &> processor2.out.log &
PROCESSOR2_PID=$!

$PROCESSOR3 &> processor3.out.log &
PROCESSOR3_PID=$!

$FILESINK &> fileSink.out.log &
FILESINK_PID=$!
