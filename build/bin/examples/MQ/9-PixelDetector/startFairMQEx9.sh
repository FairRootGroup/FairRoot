...
if [ "$FAIRTASKNAME" == "--task-name PixelFindHits" ] ; then
 ...
 #   INPUTFILE+=" --file-name /Users/turany/development/FairRoot/examples/MQ/9-PixelDetector/macros/pixel_TGeant3.digi.f1.root"
    ...
    OUTPUTFILE="/Users/turany/development/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.hits.root"
    ...
    # output file for sink
    OUTPUTFILE="/Users/turany/development/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.hits_tracks.root"
    ...
    # input file and branch for the sampler device
    INPUTFILE="/Users/turany/development/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.hits_tracks.root"
    INPUTBRANCH="PixelHits --branch-name PixelTracks"
    
    # output file for sink
    OUTPUTFILE="/Users/turany/development/FairRoot/examples/MQ/9-PixelDetector/macros/MQ.pixel_TGeant3.fitTracks.root"
...
xterm +aw -geometry 100x25+0+700 -hold -e /Users/turany/development/FairRoot/build/bin/examples/MQ/9-PixelDetector/$FILESINK &
