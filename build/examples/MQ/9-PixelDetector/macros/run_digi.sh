...
cd /Users/turany/development/FairRoot/build/examples/MQ/9-PixelDetector/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /Users/turany/development/FairRoot/examples/MQ/9-PixelDetector/macros/run_digi.C\($parameters\)
