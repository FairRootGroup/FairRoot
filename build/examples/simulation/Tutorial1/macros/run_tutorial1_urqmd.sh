...
cd /Users/turany/development/FairRoot/build/examples/simulation/Tutorial1/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /Users/turany/development/FairRoot/examples/simulation/Tutorial1/macros/run_tutorial1_urqmd.C\($parameters\)
