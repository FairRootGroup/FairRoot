...
cd /Users/turany/development/FairRoot/build/examples/simulation/Tutorial4/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /Users/turany/development/FairRoot/examples/simulation/Tutorial4/macros/run_tutorial4.C\($parameters\)
