...
cd /Users/turany/development/FairRoot/build/examples/simulation/Tutorial2/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /Users/turany/development/FairRoot/examples/simulation/Tutorial2/macros/create_digis_mixed.C\($parameters\)
