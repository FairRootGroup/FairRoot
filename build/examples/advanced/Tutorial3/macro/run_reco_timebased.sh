...
cd /Users/turany/development/FairRoot/build/examples/advanced/Tutorial3/macro

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /Users/turany/development/FairRoot/examples/advanced/Tutorial3/macro/run_reco_timebased.C\($parameters\)
