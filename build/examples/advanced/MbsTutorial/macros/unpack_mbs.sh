...
cd /Users/turany/development/FairRoot/build/examples/advanced/MbsTutorial/macros

# execute root with the defined macro and the command line parameters
$ROOTEXE -q -b /Users/turany/development/FairRoot/examples/advanced/MbsTutorial/macros/unpack_mbs.C\($parameters\)
