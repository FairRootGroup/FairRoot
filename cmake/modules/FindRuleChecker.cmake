...
if (JAVA_RUNTIME AND PERL_FOUND)
  ...
  IF(FAIRROOT_SOURCE_DIR)
    ...
    ENDFOREACH(dir)
    FIND_PATH(RULE_CHECKER_PATH FAIRRuleChecker.class PATHS
       ${RULE_CHECKER_LIBRARY_DIRECTORIES}
    )
    SET(RULE_CHECKER rules.FAIR.FAIRRuleChecker)
  ELSE(FAIRROOT_SOURCE_DIR)
  ...
  ELSE (NOT RULE_CHECKER_PATH)
    ...
    IF(FAIRROOT_SOURCE_DIR)
      SET(RULE_CHECKER_SCRIPT ${RULE_CHECKER_SCRIPT_PATH}/createFairViolationTable.sh)
      SET(RULE_CHECKER_SCRIPT1 ${RULE_CHECKER_SCRIPT_PATH}/createFairViolationTable_html.sh)
    ELSE(FAIRROOT_SOURCE_DIR)
      IF(PANDAROOT_SOURCE_DIR)
...
#        MESSAGE(HEADERDIR: ${HEADERDIR})
    ...
    ADD_CUSTOM_COMMAND(OUTPUT ${CMAKE_CURRENT_BINARY_DIR}/${OUTFILE} ${CMAKE_CURRENT_BINARY_DIR}/${OUTFILE1} ${CMAKE_CURRENT_BINARY_DIR}/${VIOLFILE} 
     COMMAND g++ -E ${_INCLUDE_DIRS}  -o  ${OUTFILE} ${_current_FILE}
