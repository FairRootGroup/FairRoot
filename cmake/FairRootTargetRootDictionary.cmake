...
function(fairroot_target_root_dictionary target)
  ...
  if(NOT lib_output_dir)
    set(lib_output_dir ${CMAKE_BINARY_DIR}/${PROJECT_INSTALL_LIBDIR})
  endif()
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -E env "LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:$ENV{LD_LIBRARY_PATH}"
      ...
      -I${CMAKE_INSTALL_PREFIX}/${PROJECT_INSTALL_INCDIR}
      -excludePath ${CMAKE_BINARY_DIR}/${CMAKE_INSTALL_INCLUDEDIR}
  ...
  set_property(GLOBAL APPEND PROPERTY ROOT_CONFIG_LIBRARY_TARGETS_${PROJECT_NAME} ${target})
endfunction()
