...
TEST(FairToolsTestFatal, TestFatalError)
{
    ...
    EXPECT_DEATH(fLogger->Fatal(MESSAGE_ORIGIN, "This is a fatal problem"), "FATAL");
...
class _TestFairLoggerBase : public T
{
  protected:
    ...
    */
    ...
    std::vector<std::string> CreateExpectedOutputNoArguments(const std::string& loglevel,
                                                             ...
                                                             const std::string& filename = "")
    {
        ...
        std::vector<std::string>::iterator position = std::find(levelNames.begin(), levelNames.end(), loglevel);
