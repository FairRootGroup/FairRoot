// -------------------------------------------------------------------------
// -----                CbmEvtGenGenerator header file                 -----
 ...
 *
 The CbmEvtGenGenerator reads an EvtGen input file. The file must contain
...
class CbmEvtGenGenerator : public CbmGenerator  
{
 ...
 public: 
   ...
   **/
  CbmEvtGenGenerator(const char* fileName);


  /** Destructor. **/
  virtual ~CbmEvtGenGenerator();
