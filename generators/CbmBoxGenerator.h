 ...
 *
 * The CbmBoxGenerator generates particles within given range
 * over pt, phi, eta, y or theta a fixed multiplicity per event.
 * Derived from CbmGenerator.
**/

/* $Id: CbmBoxGenerator.h,v 1.3 2006/07/14 11:23:57 kharlov Exp $ */

/* History of cvs commits:
 *
 * $Log: CbmBoxGenerator.h,v $
...
class CbmBoxGenerator : public CbmGenerator
{
public:
   ...
   **/
  CbmBoxGenerator(Int_t pdgid, Int_t mult=1);

  /** Destructor **/
  virtual ~CbmBoxGenerator() {};
