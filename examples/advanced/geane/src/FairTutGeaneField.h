...
#ifndef FairTutGeaneFIELD_H
#define FairTutGeaneFIELD_H 1

#include "FairField.h" // for FairField

#include "Rtypes.h" // for Double_t, etc

class FairTutGeaneField : public FairField
{
  ...
  public:
     ...
     **/
    FairTutGeaneField(const char* name,
                   Double_t xMin,
                   Double_t xMax,
                   Double_t yMin,
                   Double_t yMax,
