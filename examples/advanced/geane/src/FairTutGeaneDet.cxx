...
FairTutGeaneDet::FairTutGeaneDet()
  : FairDetector("FairTutGeaneDet", kTRUE, kTutGeane),
    fTrackID(-1),
    fVolumeID(-1),
    fPos(),
    fMom(),
...
void FairTutGeaneDet::Initialize()
{
...
{
  if (iColl == 0) { return fFairTutGeanePointCollection; }
  else { return NULL; }
}
...
void FairTutGeaneDet::ConstructGeometry()
{
  /** If you are using the standard ASCII input for the geometry
    ...
    FairTutGeaneGeo*  Geo  = new FairTutGeaneGeo();
    ConstructASCIIGeometry<FairTutGeaneGeo, FairTutGeaneGeoPar>(Geo, "FairTutGeaneGeoPar");
}

void FairTutGeaneDet::ModifyGeometry() {  
...
FairTutGeanePoint* FairTutGeaneDet::AddHit(Int_t trackID, Int_t detID,
                                      ...
                                      Double_t eLoss)
{
  TClonesArray& clref = *fFairTutGeanePointCollection;
  Int_t size = clref.GetEntriesFast();
  return new(clref[size]) FairTutGeanePoint(trackID, detID, pos, mom,
         time, length, eLoss);
}
